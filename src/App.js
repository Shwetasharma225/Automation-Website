...
import LandingPg from './components/LandingImg';
import Tailblock from './components/tailblock';
        ...
        <div className="row row-offcanvas row-offcanvas-left">
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/signin" element={<SignIn setUserId={setUserId} setUserName={setUserName} />} />
